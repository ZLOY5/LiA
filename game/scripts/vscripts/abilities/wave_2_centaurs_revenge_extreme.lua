wave_2_centaurs_revenge_extreme = class({})


LinkLuaModifier("modifier_2_wave_centaurs_revenge", "abilities/wave_2_centaurs_revenge_extreme.lua", LUA_MODIFIER_MOTION_NONE)


function wave_2_centaurs_revenge_extreme:GetIntrinsicModifierName()
