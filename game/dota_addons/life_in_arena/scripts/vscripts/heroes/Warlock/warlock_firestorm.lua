...
LinkLuaModifier("modifier_warlock_firestorm_burn","heroes/DarkKnight/modifier_warlock_firestorm_burn.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_warlock_firestorm_channel","heroes/DarkKnight/modifier_warlock_firestorm_channel.lua",LUA_MODIFIER_MOTION_NONE)
