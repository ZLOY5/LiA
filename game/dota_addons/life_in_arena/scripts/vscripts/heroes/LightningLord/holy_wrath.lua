LinkLuaModifier("modifier_lord_of_lightning_holy_wrath_slow", "heroes/LightningLord/modifier_lord_of_lightning_holy_wrath_slow.lua",LUA_MODIFIER_MOTION_NONE)
