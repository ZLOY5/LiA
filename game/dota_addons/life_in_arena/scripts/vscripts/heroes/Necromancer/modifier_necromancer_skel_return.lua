modifier_necromancer_skel_return = class({})

function modifier_necromancer_skel_return:IsHidden()
	return true
end
...
function modifier_necromancer_skel_return:OnAttackLanded(params) 
...
function modifier_necromancer_skel_return:OnTakeDamage(params)
