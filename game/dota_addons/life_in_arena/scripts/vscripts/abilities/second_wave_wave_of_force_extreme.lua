second_wave_wave_of_force_extreme = class({})

--------------------------------------------------------------------------------

function second_wave_wave_of_force_extreme:OnSpellStart()
	if IsServer() then
...
function second_wave_wave_of_force_extreme:OnProjectileHit( hTarget, vLocation )
	if IsServer() then
