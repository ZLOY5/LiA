...
wave_18_bash = class({})
LinkLuaModifier( "modifier_wave_18_bash", "abilities/wave_18_bash.lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function wave_18_bash:GetIntrinsicModifierName()
	return "modifier_wave_18_bash"
end

--------------------------------------------------------------------------------


modifier_wave_18_bash = class({})

--------------------------------------------------------------------------------

function modifier_wave_18_bash:IsHidden()
	return true
end

--------------------------------------------------------------------------------

function modifier_wave_18_bash:IsPurgable()
	return false
end

--------------------------------------------------------------------------------

function modifier_wave_18_bash:OnCreated( kv )
...
function modifier_wave_18_bash:DeclareFunctions()
	local funcs =
	{
...
function modifier_wave_18_bash:OnAttackLanded( params )
	if IsServer() then
