...
/*function _ScoreboardUpdater_UpdateTeamPanel( scoreboardConfig, containerPanel, teamId, teamsInfo )  //teamDetails
{
	$.Msg( "				_ScoreboardUpdater_UpdateTeamPanel 		BEGIN" );
	if ( !containerPanel )
		return;
	...
	if ( playersContainer )
	{
		...
		for ( var playerId of teamPlayers )
		{
			...
			_ScoreboardUpdater_UpdatePlayerPanelMy( scoreboardConfig, playersContainer, playerId, localPlayerTeamId )
		}
	}
...
//			$.Msg( gradientText );
	...
	$.Msg( "				_ScoreboardUpdater_UpdateTeamPanel 		END" );
	return teamPanel;
}*/
...
/*function _ScoreboardUpdater_UpdateAllPlayers( scoreboardConfig, teamsContainer )
{
	//
	var localPlayerTeamId = -1;
	var localPlayer = Game.GetLocalPlayerInfo();
	...
	//teamPanel.SetHasClass( "local_player_team", localPlayerTeamId == teamId );
	//teamPanel.SetHasClass( "not_local_player_team", localPlayerTeamId != teamId );
	$.Msg( "                  _ScoreboardUpdater_UpdateAllPlayers: ", localPlayerTeamId );
	var allPlayers = Game.GetPlayerIDsOnTeam( localPlayerTeamId )
	//var playersContainer = teamPanel.FindChildInLayoutFile( "PlayersContainer" );
	//var playersContainer = scoreboardPanel
	var teamsInfo = { max_team_players: 0 };
	_ScoreboardUpdater_UpdateTeamPanel( scoreboardConfig, teamsContainer, localPlayerTeamId, teamsInfo );
	//if ( playersContainer )
	{
		//if (scoreboardConfig["updatePlayersCount"])
		{
